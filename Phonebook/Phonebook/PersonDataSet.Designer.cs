...
namespace Phonebook {
    ...
    public partial class PersonDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonRow FindByPhoneId(int PhoneId) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public int PhoneId {
                get {
                    return ((int)(this[this.tablePerson.PhoneIdColumn]));
                }
                set {
                    this[this.tablePerson.PhoneIdColumn] = value;
                }
            }
...
namespace Phonebook.PersonDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([PhoneId] = @Original_PhoneId) AND ([Name] = @" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Name], [Phone]) VALUES (@Name, @Phone);\r\nSELECT Phon" +
                "eId, Name, Phone FROM Person WHERE (PhoneId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Person] SET [Name] = @Name, [Phone] = @Phone WHERE (([PhoneId] = @O" +
                "riginal_PhoneId) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone));" +
                "\r\nSELECT PhoneId, Name, Phone FROM Person WHERE (PhoneId = @PhoneId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Phonebook.Properties.Settings.Default.PhonelistConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PhoneId, Name, Phone FROM dbo.Person";
        ...
        public virtual int Delete(int Original_PhoneId, string Original_Name, string Original_Phone) {
        ...
        public virtual int Update(string Name, string Phone, int Original_PhoneId, string Original_Name, string Original_Phone, int PhoneId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, int Original_PhoneId, string Original_Name, string Original_Phone) {
            return this.Update(Name, Phone, Original_PhoneId, Original_Name, Original_Phone, Original_PhoneId);
        }
    }
